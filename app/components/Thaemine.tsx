    ...
    return (
        <div className='w-full h-full flex flex-col items-center'>
            ...
            <div className='w-full h-full flex flex-col items-center'>
                ...
                <TallyComponent name={'Pug Bozo 1'} deathCount={player7DeathCount} wipeCount={player7WipeCount} deathCounterIncrement={()=>setPlayer7DeathCount(player7DeathCount+1)} deathCounterDecrement={() => setPlayer7DeathCount(player7DeathCount-1)} wipeCounterIncrement={() => setPlayer7WipeCount(player7WipeCount+1)} wipeCounterDecrement={() => setPlayer7WipeCount(player7WipeCount-1)}/>
                <TallyComponent name={'Pug Bozo 2'} deathCount={player8DeathCount} wipeCount={player8WipeCount} deathCounterIncrement={()=>setPlayer8DeathCount(player8DeathCount+1)} deathCounterDecrement={() => setPlayer8DeathCount(player8DeathCount-1)} wipeCounterIncrement={() => setPlayer8WipeCount(player8WipeCount+1)} wipeCounterDecrement={() => setPlayer8WipeCount(player8WipeCount-1)}/>
            </div>
        </div>
    )
}
